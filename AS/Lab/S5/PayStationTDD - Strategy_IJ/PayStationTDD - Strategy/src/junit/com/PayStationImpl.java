...
public class PayStationImpl implements PayStation {
  ...
  */
  public PayStationImpl( RateStrategy rateStrategy ) {
    ...
    this.state = new Revision();
    this.state2 = new Revised();
  }
  ...
  public String getStateInfo() {return state.getInfoState();}
  public String getStateInfo2() {return state2.getInfoState();}
}
